...
We also measured the effective sample size per iteration, verifying that this was not low enough to indicate improper sampling.
We also checked that there were no post-warmup divergent transitions.
