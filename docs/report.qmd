...
The group contribution (GC) model addresses the reactant contribution model's lack of coverage by allowing some unmeasured compounds' formation energies to be estimated, provided these compounds are composed of a set of predetermined chemical groups.
