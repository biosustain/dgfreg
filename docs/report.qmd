...
The Gibb's energy of a reaction (or Gibb's **free** energy of reaction) represents the amount of usable energy released by a reaction <!-- TODO confirm --> and can be calculated as a function of the Gibb's energy of formation of its substrates. 
Under standard conditions the overall rate $v$ of a reaction is given by:
<!--JJ: I would maybe go with the TMFA eqns here instead. Otherwise it looks like a linear relationship between dgr and flux-->
\begin{align}
...
\end{align}
where, $n\in\mathbb{N}$ species depends on formation energies $\Delta_f
...
These estimation methods rely on experimental measurements of $\Delta_rG$.
...
<!--JJ: This notation could be a bit more elegant-->
\begin{align}
